...
| 4 | **Block (Current Focus)** | Block Header, Hash, Coinbase Tx, Merkle Tree, Block Subsidy vs Fees, Reorgs. | Membedah struktur blok sebagai detak jantung ekonomi yang tidak bisa dimanipulasi. |
