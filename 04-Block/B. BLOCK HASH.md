...
**1. Analogi Jus Alpukat dan Hashing**
...
- **Deterministik:** Input yang sama akan selalu menghasilkan kode hash yang sama. Mirip seperti jus alpukat, jika kamu menggunakan blender yang sama dengan bahan yang sama persis (misal: 1 buah alpukat atau lebih + susu), hasilnya akan selalu menghasilkan warna dan rasa jus yang identik.
...
Setelah dicacah, data tersebut "diaduk" melalui serangkaian operasi logika (seperti pergeseran posisi bit dan penambahan matematis) berkali-kali. Hasil akhirnya selalu memiliki panjang yang tetap (misalnya 64 karakter pada SHA-256), tidak peduli apakah inputnya hanya satu kata atau seluruh isi perpustakaan. Ibarat seperti jus alpukat, buahnya dipotong-potong. Setelah diblender (dihashing), hasilnya tetaplah jus alpukat. Tidak peduli apakah satu buah atau 1 truk alpukat.
...
- Eksperimen 1: Data Transaksi + Nonce `0` = Hash `8f2c...` (Gagal/Warna & rasa tidak sesuai).
