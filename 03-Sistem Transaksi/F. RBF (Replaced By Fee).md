...
- Anda membuat transaksi baru menggunakan input yang sama (UTXO yang sama).
- Anda mengatur biaya transaksi ($fee$) yang lebih tinggi dari sebelumnya.
...
3. Manfaat Utama
- Efisiensi Biaya: Anda bisa mulai dengan fee rendah saat jaringan sepi, dan hanya menaikannya jika ternyata jaringan tiba-tiba sibuk.
